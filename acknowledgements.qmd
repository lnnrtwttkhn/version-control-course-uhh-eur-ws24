...
Our ILLF@home project proposal can be found [here]({{< var project.illf-proposal >}}).
...
Our DDLitLab project proposal can be found [here]({{< var project.ddlitlab-proposal >}}) (in German).
