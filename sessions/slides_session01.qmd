...
- Implemented in the [formr]({{< var project.formr >}}) survey framework (open-source, hosted in Germany)
:::
...
1. Read [Chapter 1: "Introduction to Version Control"](https://lennartwittkuhn.com/version-control-book/chapters/intro-version-control.html) in the [Version Control Book]({{< var project.book >}})
...
![by [Scriberia]({{< var project.scriberia >}}) for @turingway2022 ([Link](https://zenodo.org/record/3678226/), [CC BY
4.0]({{< var project.ccby40 >}}))](../images/turing-way-reproducibility.png)
:::
::::
:::: {.column width="50%"}
::: {.fragment}
