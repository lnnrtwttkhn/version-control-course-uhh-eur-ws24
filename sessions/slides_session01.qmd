...
- {{< fa envelope >}} Our mailing list: [{{< var links.email-mailing-list >}}]({{< var links.mailto-mailing-list >}})
:::

::: {.fragment}
### Your role
- activate participation
  - come to at least 12 out of 14 sessions (sign the attendance list)
