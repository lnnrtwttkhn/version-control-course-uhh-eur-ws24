...
- No idea (e.g. "I don’t know what that is")

- "Ich glaube dabei handelt es sich um ein Tool, das Änderungen am Projekt ( Inhalte, Statistik, Programmierung) speichert bzw. Alle Versionen einer Datei abspeichert und nicht nur die neusten"
