...
{{< fa envelope >}} [{{< var links.email >}}]({{< var links.mailto >}})<br>
...
{{< fa brands github >}} **Source:** Source code is available at [{{< var links.github >}}]({{< var links.github >}})
...
:speech_balloon: **Contact:** I welcome any feedback via [email]({{< var links.mailto >}}) or [GitHub issues]({{< var issues >}}).
Thank you!
:::
