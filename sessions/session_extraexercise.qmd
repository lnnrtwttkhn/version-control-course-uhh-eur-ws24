...
So please [get in touch]({{< var links.mailto >}}) if you are getting stuck or have any questions about the assignment or the course contents.
...
You complete this assignment by sending a link to your `recipes` repository [to Lennart]({{< var links.mailto >}}).
